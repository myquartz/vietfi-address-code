...
class TestAddressDictionary(unittest.TestCase):

    def test_load_special_mapping(self):
        ...
        expected_params = {'database': {'path': '../db/country_div_sub.sqlite3', 'driver': 'sqlite3', 'timeout': 10000}}
        ...
        self.assertEqual(adh.special_division, expected_special_division)
        self.assertEqual(adh.special_division_sub_div, expected_special_subdiv)
